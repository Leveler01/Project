...
Adodc1.RecordSource = "Select * from products where pname='" + Text1.Text + "'"
Adodc1.Refresh
...
Adodc1.RecordSource = "Select * from products where companyname='" + Text2.Text + "'"
Adodc1.Refresh
If Adodc1.Recordset.EOF Then
MsgBox "Data not Found!!!", vbCritical, "Message"
Else
...
Adodc1.RecordSource = "selec * from products"
Adodc1.Refresh
Adodc1.Caption = Adodc1.RecordSource
End Sub
